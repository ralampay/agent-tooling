...
from tools import get_name, greet
...
class HelloAgent:
    def __init__(self):
        ...
        self.agent = Agent(
            model=self.model,
            tools=[get_name, greet],
            system_prompt=(
                "You are a simple agent.\n"
                "If the user wants to greet someone, you MUST use tools.\n"
                "If the user does not provide a name, you MUST call get_name first.\n"
                "Then pass the result to greet.\n"
